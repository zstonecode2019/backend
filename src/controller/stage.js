...
const save = async (req, res) => {
    const { uuid,name,page_id,engine,render_info,effect_info,aspect } = req.body;
    const result = await stageService.save({ uuid,name,page_id,engine,render_info,effect_info,aspect });
    if (result) {
